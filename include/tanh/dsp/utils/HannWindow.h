 ...
 *
 * This class implements a Hann (raised cosine) window function for granular
 * synthesis. It provides a smooth bell-shaped envelope that is particularly
...
public:
    ...
    /**
     * Process a single sample and return the envelope value at the current
     * position
     *
